...
requireGate(manifest.v1Data.restoreDrill.fullRestorePreparation.status === 'ready-for-fresh-format-v2-backup' && manifest.v1Data.restoreDrill.fullRestorePreparation.productionTouched === false && manifest.v1Data.restoreDrill.fullRestorePreparation.stagingPaused === false, 'full restore is prepared without touching Production or pausing Staging');
