...
const messages = {
  de: {
    ...
    staging: 'V2 Staging',
    overview: 'Übersicht',
    foundation: 'Globales Career Engine',
    ...
    nextCopy: 'XP, Level und Rank als korrigierbare Progression aus offiziellen Events.',
    language: 'Sprache',
  },
  en: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Overview', foundation: 'Global Career Engine',
    ...
    nextCopy: 'XP, level, and rank as correctable progression from official events.', language: 'Language',
  },
  es: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Resumen', foundation: 'Motor de carrera global',
    ...
    nextCopy: 'XP, nivel y rango como progreso corregible desde eventos oficiales.', language: 'Idioma',
  },
  fr: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Vue d’ensemble', foundation: 'Moteur de carrière global',
    ...
    nextCopy: 'XP, niveau et rang comme progression corrigible issue des événements officiels.', language: 'Langue',
  },
} as const;
