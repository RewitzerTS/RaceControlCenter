...
const messages = {
  de: {
    ...
    staging: 'V2 Staging',
    overview: 'Übersicht',
    foundation: 'Zuverlässige Domain Events',
    ...
    nextCopy: 'Career Engine für deterministische Fahrerhistorie, Statistiken und Fortschritt.',
    language: 'Sprache',
  },
  en: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Overview', foundation: 'Reliable domain events',
    ...
    nextCopy: 'Career Engine for deterministic driver history, statistics, and progression.', language: 'Language',
  },
  es: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Resumen', foundation: 'Eventos de dominio fiables',
    ...
    nextCopy: 'Motor de carrera para historial, estadísticas y progreso deterministas.', language: 'Idioma',
  },
  fr: {
    product: 'RaceVora', staging: 'V2 Staging', overview: 'Vue d’ensemble', foundation: 'Événements métier fiables',
    ...
    nextCopy: 'Moteur de carrière pour un historique, des statistiques et une progression déterministes.', language: 'Langue',
  },
} as const;
