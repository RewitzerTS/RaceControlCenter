...
const messages = {
  de: {
    ...
    nextCopy: 'Globale Driver Identity und sichere Verknüpfung registrierter Fahrer.',
    language: 'Sprache',
  },
  en: {
    ...
    nextCopy: 'Global driver identity and secure linking for registered drivers.', language: 'Language',
  },
  es: {
    ...
    nextCopy: 'Identidad global del piloto y vinculación segura de pilotos registrados.', language: 'Idioma',
  },
  fr: {
    ...
    nextCopy: 'Identité globale du pilote et liaison sécurisée des pilotes inscrits.', language: 'Langue',
  },
} as const;
