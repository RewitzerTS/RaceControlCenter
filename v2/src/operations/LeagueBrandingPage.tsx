...
const THEMES = [
  { id: 0, name: 'Midnight', colors: ['#00e5e5', '#199cff', '#8228ff'] },
  { id: 1, name: 'RaceVora', colors: ['#2c8fa6', '#7653c7', '#f4c14d'] },
  { id: 2, name: 'Papaya', colors: ['#ff8700', '#47c7fc', '#111827'] },
  { id: 3, name: 'Rosso', colors: ['#ef1a2d', '#ffd400', '#171717'] },
  { id: 4, name: 'Silver', colors: ['#00a19c', '#c9d2d9', '#111827'] },
  { id: 5, name: 'Electric', colors: ['#00e5ff', '#3153ff', '#d700ff'] },
  { id: 6, name: 'Emerald', colors: ['#19c37d', '#a7f3d0', '#052e2b'] },
  { id: 7, name: 'Monochrom', colors: ['#f5f5f5', '#9ca3af', '#111111'] },
] as const;
  ...
  return <main className="operations-page admin-form-page" id="main-content">
    ...
    <div className="branding-layout">
      <form className="admin-form" onSubmit={(event) => void submit(event)}>
        ...
        <label><span>Beschreibung</span><textarea maxLength={600} rows={4} value={branding.description} onChange={(event) => patch('description', event.target.value)} /></label>
