...
export function OwnerControlPage() {
  ...
  return <main className="operations-page" id="main-content">
    ...
    <header className="operations-header"><div><p className="section-label">{t('owner.eyebrow')}</p><h1>{t('owner.title')}</h1><p>{t('owner.copy')}</p></div><button className="primary-action" type="button" onClick={() => navigate('/owner/leagues/new')}>Liga erstellen</button></header>
