...
export function LeagueDriversPage() {
  ...
  return <main className="operations-page admin-management-page" id="main-content">
    <header className="operations-header"><div><p className="section-label">V1 Admin · {leagueSlug}</p><h1>Fahrer verwalten</h1><p>Startnummern, Teams, Fahrzeuge und aktive Fahrer der ausgewählten Liga pflegen. Bestehende Ergebnisse werden beim Bearbeiten nicht verändert.</p></div><div className="admin-header-actions"><button className="primary-action" onClick={() => setEditing({ ...EMPTY_DRIVER })} type="button">Fahrer anlegen</button><NavLink className="text-link" to="/admin">Zum Admin-Menü</NavLink></div></header>
