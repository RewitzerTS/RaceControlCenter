...
Die vollständige Freigabeprüfung bestand anschließend mit 297 Tests in 59 Dateien, sämtlichen Vertrags-/Build-Prüfungen und 72 Desktop-/Mobil-Browsertests. Zwei vorherige Anläufe wurden wegen eines ausgefallenen lokalen Testservers bzw. zweier Navigation-Zeitüberschreitungen nicht veröffentlicht; keine Prüfungen wurden übersprungen oder gelockert. Staging veröffentlicht Quellstand `132d3bd8c9f3cf8e637287a8cb1c6666545fd5c4`, Worker-Version `2e5d2822-b6ed-4373-9056-233d97da94bc`. Öffentliche Build-Kennungen bestätigen die Staging-Datenbank sowie unveränderte Production auf `d0c6f6b8b232e2781a5c32c3095bbd5085b03275`.

## Freigegebene Production-Übernahme, 2026-09-09

Nach ausdrücklicher Nutzerfreigabe wurde `2b156ba418745451744cd051acd241b01178d907` auf `racevora-v2-production` veröffentlicht, Version `640d5add-10b5-42b7-9153-5c577712d917`. Gegenüber dem geprüften Staging-Commit enthält dieser Stand ausschließlich zusätzliche Prüfdokumentation, keinen anderen Anwendungscode. Der vollständige Release-Gate bestand mit 297 Tests und 72 Browserprüfungen; nach lokalen Worker-Startzeitüberschreitungen wurde nur die Vitest-Parallelität für diesen Aufruf auf zwei Prozesse begrenzt. Keine Tests übersprungen, keine Datenbankänderungen oder QA-Datenübertragung. Die öffentliche Build-Kennung von racevora.com bestätigt den neuen Production-Commit und die unveränderte Production-Datenbank. Bisherige Worker-Version als Rückweg: `c89789c1-e212-417f-bffa-766d11ab4a96`.

Der zusätzliche GitHub-Push auf `main` wurde zunächst durch die automatische Aktionsprüfung mangels expliziter Branch-Freigabe blockiert. Der Nutzer erteilte anschließend ausdrücklich die Freigabe für den Push auf `main`. Die Browser-Verbindung brach bei der abschließenden Neuladung ab; eine angemeldete Live-Sichtprüfung konnte daher nicht abgeschlossen werden.
