const RCC_TRACKS = [
  ...
  { key: 'austria', trackMapFile: 'redbullring.png', grandPrixName: 'Österreich GP', circuitName: 'Red Bull Ring', countryCode: 'AT', aliases: ['österreich gp', 'osterreich gp', 'austria gp', 'austrian gp', 'red bull ring'], weatherPresets: ['klar', 'regen', 'dynamisch'], svgPath: 'M22 74 L42 28 L94 20 L132 44 L110 82 L54 90 Z' },
