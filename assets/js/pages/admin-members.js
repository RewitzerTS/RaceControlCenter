(() => {
  ...
  async function functionErrorMessage(error) {
    ...
    if (/failed to send a request/i.test(message)) return 'Der Einladungsdienst ist momentan nicht erreichbar. Bitte Verbindung prüfen und erneut versuchen.';
    if (/non-2xx/i.test(message)) return 'Die Einladung wurde vom Server abgelehnt. Bitte später erneut versuchen.';
    return message;
  }
